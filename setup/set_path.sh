...
export GPTO_MODEL_NAME="gpt-4o" # version used at development
export GPTV_MODEL_NAME="gpt-4-turbo" # version used at development
export GPT_MODEL_NAME="gpt-3.5-turbo" # version used at development
# ----------------</INPUT required>----------------
